...
public interface TasksService {
    ...
    Tasks findTasksById(TenantId tenantId, TasksId tasksId);

    Tasks saveTasks(Tasks tasks);

    void deleteTasks(TenantId tenantId, TasksId tasksId);

   // Tasks findTasksByTrellaId(TenantId tenantId,TrellaId trellaId);
